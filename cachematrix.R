...
## computing it repeatedly. This pair of functions will cache the 
## inverse of a matrix.
...
## special "vector" created with the makeCacheMatrix function.
## It first checks to see if the inverse of the matrix has already
## been calculated. If so, it gets the value from the cache and 
## returns the value. Otherwise, it solves the inverse of the matrix
